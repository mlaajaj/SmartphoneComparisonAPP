...
def main():
    ...
    if choice == "Home":
        ...
        with col1:
            ...
            category = st.selectbox("Category", ['First Name', 'Last Name','Animals','Positive Words', "Negative Words"])
        ...
        with col2:
            st.success('Names List')
            buy = st.multiselect('Buy', ['milk', 'apples', 'potatoes'])
            st.write(buy)
